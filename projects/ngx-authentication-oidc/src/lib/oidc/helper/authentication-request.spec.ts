...
describe('AuthenticationRequest', () => {
  ...
  it("Create Auth Request default params", () => {
    const loginOptions = {};
    const result = new AuthenticationRequest(loginOptions, "https://example.com/rd", "id", "https://example.com/auth").toUrl();
  ...
  it("Create Auth Request special params", () => {
    ...
    const result = new AuthenticationRequest(loginOptions, "https://example.com/rd222", "id", "https://example.com/auth").toUrl();
